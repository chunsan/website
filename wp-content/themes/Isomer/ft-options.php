...
function FT_OP_options()
{
	...
	$options[] = array( "name" => "Intro text ",
						"desc" => "intro text on the homepage",
						"id" => "fabthemes_intro",
						"type" => "textarea");		

	$options[] = array( "name" => "Portfolio items count ",
						"desc" => "Number of portfolio items on the homepage",
						"id" => "fabthemes_folio_count",
						"std" => "12",
						"type" => "text");	

	$options[] = array( "name" => "Latest posts count ",
						"desc" => "Number of latest posts on the homepage",
						"id" => "fabthemes_post_count",
						"std" => "6",
						"type" => "text");	
